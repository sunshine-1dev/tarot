      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold mb-2">
            <span className="text-gold-gradient">欢迎回来</span>
          </h1>
          <p className="text-text-secondary text-sm">登录你的星语塔罗账号</p>
        </div>
        ...
        <div className="bg-bg-secondary/60 backdrop-blur-sm border border-accent-purple/20 rounded-2xl p-8">
          ...
          <p className="text-center text-text-secondary text-sm mt-6">
            还没有账号？{' '}
            <Link to="/auth/signup" className="text-accent-gold hover:underline">
              立即注册
            </Link>
          </p>
        </div>
